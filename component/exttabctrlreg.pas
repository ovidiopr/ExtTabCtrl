...
begin
  ...
  RegisterPropertyEditor(TypeInfo(TImageIndex), TExtButtonImageIndexes, '', TExtTabCtrlImageIndexProperty);
end;
...
begin
  ...
  else if P is TExtButtonImageIndexes then
    TC := TExtTabCtrl(TExtButtonImageIndexes(P).GetOwner)
  else
    Exit;
