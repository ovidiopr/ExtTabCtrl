...
//    ACanvas.FillRect(CloseR);
  ...
  begin
    imgRes := FInternalBtnImages.ResolutionForPPI[0, ppi, scale];
    imgRes.Draw(ACanvas,
      CloseR.Left + (CloseR.Width - imgRes.Width) div 2,
      CloseR.Top + (CloseR.Height - imgRes.Height) div 2,
      cCloseIndex,
...
begin
  ...
  begin
    ...
    if FButtonImages.NextIndex > -1 then
    begin
